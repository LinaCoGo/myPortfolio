        ...
        <>
            ...
            <div className='app__footer-cards'>
                <div className='app__footer-card'>
                    ...
                    <a href='mailto:justme_obe86@hotmail.com' className='p-text'>lina.tamara.contreras@gmail.com</a>
                </div>

                <div className='app__footer-card'>
                    <img src={images.mobile} alt='mobile'></img>
                    <a href='tel:+52(123456789)' className='p-text'>tel:+52(33 24 97 3664)</a>
                </div>
            </div>
